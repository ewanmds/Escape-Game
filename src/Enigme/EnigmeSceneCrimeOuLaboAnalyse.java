...
public class EnigmeSceneCrimeOuLaboAnalyse implements Enigmes {
    ...
    public EnigmeSceneCrimeOuLaboAnalyse(String motDePasse, int xZone, int yZone) {
    ...
    //Renvoie si l'énigme est résolue
    ...
    public void verifierEtAfficher(JPanel panel, Personnage p) {
        ...
        if (distance < 100 && !champAjoute && !resolue) {
            ...
            //Ajout d'un listener pour vérifier le mot de passe
            if (!listenerAjoute) {
